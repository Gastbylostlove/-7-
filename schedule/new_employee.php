...
<head>
    ...
    <link rel="stylesheet" href="new_employee.css" />
...
<body>
    <div class="container">
        ...
        <div class="프로필">
            <div class='box'>
                <img class="사진"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQnKWk_1Hfnkizm7nuET-oPvId_DbEE3kk0g&usqp=CAU">
            </div>
    ...
    <input type="hidden" name="name" value="곽두팔">
    <input type="hidden" name="phoneNumber" value="010-1234-5678">
</form>
        </div>
        <div class="back">
            <!-- x 버튼 클릭 이벤트를 삭제 -->
        ...
        <div class="내용">
            <div class="근로자_유형">
                <span class="근로자_text">근로자유형</span>
                <div class="radio-group">
                    <label>
                        <input class="type_text" type="radio" name="option" value="일용근로자" />
                        일용근로자
                    </label>
                    <label>
                        <input class="type_text" type="radio" name="option" value="상시근로자" />
                        상시근로자
                    </label>
                    <label>
                        <input class="type_text" type="radio" name="option" value="프리랜서" />
                        프리랜서
                    </label>
                </div>
            </div>
            ...
            <!-- 시급 입력 -->
            <div class="salary">
                <span class="시급_text">시급</span>
                <div class="salary_input">
                    <input type="number" min="0" step="10" placeholder="시급입력" />
                    <span>원</span>
                </div>
            </div>
            ...
            <!-- 4대보험 -->
            <div class="insurance">
                <span class="보험_text">4대보험</span>
                <!-- 건강보험과 산재보험이 한 행 -->
                <div class="insurance_row">
                    <div class="select_insurance">
                        <input class="switch1" type="checkbox" id="switch1" name="switch1" value="private" />
                        <label for="switch1">
                            <span class="switch-x-text">건강보험</span>
                        </label>
                    </div>

                    <div class="select_insurance">
                        <input class="switch2" type="checkbox" id="switch2" name="switch2" value="private" />
                        <label for="switch2">
                            <span class="switch-x-text">산재보험</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="insurance_row">
                    <div class="select_insurance">
                        <input class="switch3" type="checkbox" id="switch3" name="switch3" value="private" />
                        <label for="switch3">
                            <span class="switch-x-text">고용보험</span>
                        </label>
                    </div>

                    <div class="select_insurance">
                        <input class="switch4" type="checkbox" id="switch4" name="switch4" value="private" />
                        <label for="switch4">
                            <span class="switch-x-text">국민연금</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <!-- 요일/시간 선택 -->
            <div class="select_day_text">요일/시간</div>
            <!--요일 선택-->
            <div class="checkbox">
                <select class="daybox">
        ...
        <div class="저장">
            <div class="저장-box">
                <div class="text">
                    <button onclick="location.href='complete.html'">저 장</button>
                </div>
            </div>
        </div>
    </div>
